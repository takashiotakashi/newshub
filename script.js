const API_KEY = `39dbb32b41d84f25ada68b8ba9fe93b3`;
...
function fetchNews(isSearching){
  ...
  if (isSearching){
    ...
    url = `https://newsapi.org/v2/everything?q=${keyword}&from=2024-02-14&sortBy=publishedAt&apiKey=${API_KEY}&page=${currentPage}`;
  }else{
